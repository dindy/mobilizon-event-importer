...
export default {
    ...
    components: {
        AutomationHistory: {
            ...
            fbWarningTitle: "Limitations de Facebook",      
            fbWarning2Text: "Seuls les 10 prochains événements seront importés même si plus d'événements sont créés dans Facebook.",
            fbWarning2Title: "Limitations de Facebook (2)" 
        },
        Automations: {
